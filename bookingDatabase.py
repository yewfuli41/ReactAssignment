...
cursor.execute('''INSERT INTO bookings(user_id, service, dentistName, bookingDate, timeSlot, amount) 
                  VALUES(?, "Dental Consultation", "Dr Micheal Thompson", "2025-04-26", "3:30PM-5:00PM", 50.00)''', (user_id,))
cursor.execute('''INSERT INTO bookings(user_id, service, dentistName, bookingDate, timeSlot, amount) 
                  VALUES(?, "Scaling", "Dr Lee Wei", "2025-04-25", "5:30PM-7:00PM", 100.00)''', (user_id,)) 
cursor.execute('''INSERT INTO bookings(user_id, service, dentistName, bookingDate, timeSlot, amount) 
                  VALUES(?, "X-Ray", "Dr Muhammad Faizal Ismail", "2025-04-29", "1:30PM-3:00PM", 150.00)''', (user_id,))
db.commit()
db.close()